...
LibLibHaru_Win = C:/cygwin64/usr/local/lib/libhpdf.a -lz -lm -lpthread -IC:/cygwin64/user/include -IC:/cygwin64/usr/local/include
...
FlagWCO_Win = -IC:\msys64\home\maximilian\Git\WCO\headers $(OP) 
